...
function Weapon(def, hp, mag, name, price, spd, str, type){
  this.def = def;
  this.hp = hp;
  this.mag = mag;
  this.name = name;
...
const magRock       = new Weapon(0,0,0.5,'Magic Rock',50,0,0,'Blunt');
const dagger        = new Weapon(0,0,0,'Dagger',250,0,1.5,'Knife');
const hiddenBlade   = new Weapon(1,5,0,'Hidden Blade',5000,1,4,'Special');
const katana        = new Weapon(1,2,1,'Katana',2500,0,2.5,'Katana');
const fallenBane    = new Weapon(0.5,4,0,"Fallen Bane",5000,1,3,'Katana');
const shiv          = new Weapon(0,0,0,'Shiv',250,0.5,1,'Knife');
const staff         = new Weapon(0,0,1,'Staff',200,0,0.5,'Staff');
const magMissle     = new Weapon(1,0,5,'Magic Missle',5000,0,1,'Staff');
const sword         = new Weapon(0,0,0,'Sword',200,0,1.5,'Sword');
const swordOfOnyx   = new Weapon(1.5,7,1,'Sword of Onyx',5000,1,4,'Sword');
const ironSword     = new Weapon(0,0,0,'Iron Sword',300,0,2,'Sword');
...
const prisonShank   = new Weapon(0,0,0,'Prison Shank',500,0,3,'Knife');
const whip          = new Weapon(0,0,0,'Whip',200,1,1,'Special');
const spear         = new Weapon(0,0,0,'Spear',500,0,2,'Special');
const mytheralSword = new Weapon(1,3,3,'Mytheral Sword',6000,1.5,4,'Sword');
const deathScythe   = new Weapon(3,7,7,"Death's Scythe",30000,-2,7,'Scythe');
...
const rapier        = new Weapon(0.5,0.5,0,"Rapier",3000,2,4.5,'Sword');
